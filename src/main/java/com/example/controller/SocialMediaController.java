...
public class SocialMediaController {
    ...
    public ResponseEntity<List<Message>> getMessages(@PathVariable int accountId) {
        return ResponseEntity.status(HttpStatus.OK).body(messageService.getAllMessages(accountId));
    }
